...
st.write ("<sup>2</sup>University of Glasgow, , Glasgow, G12 8QQ, Scotland, United Kingdom")
st.write ("<sup>3</sup>Research Center for Theoretical Physics, Central Visayan Institute Foundation, Jagna, Bohol, Philippines")
